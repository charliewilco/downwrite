...
const saveAs = () => {
  ...
  let getURL = () => window.URL || window.webkitURL || window

  let link = document.createElementNS('http://www.w3.org/1999/xhtml', 'a')
  let isLinkSavable = 'download' in link
  ...
  let throwOutside = function(ex) {
    setImmediate(function() {
      throw ex
    }, 0)
  }

  let defaultFileType = 'application/octet-stream'

  const REVOKE_TIMEOUT = 1000 * 40
  let revoke = file => {
    ...
    setTimeout(revoker, REVOKE_TIMEOUT)
  }
