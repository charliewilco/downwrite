// flow-typed signature: d32d957f2539629fa4f9f0314087a19b
// flow-typed version: 30e72b3fd6/lodash_v4.x.x/flow_>=v0.55.x
...
declare module 'lodash/fp' {
  ...
  declare class Lodash {
    ...
    findFrom<T>(
      predicate: Predicate<T> | OPredicate<T>
    ): ((fromIndex: number) => (collection: Array<T> | { [id: any]: T }) => T | void) &
      ((fromIndex: number, collection: Array<T> | { [id: any]: T }) => T | void);
    findFrom<T>(
      predicate: Predicate<T> | OPredicate<T>,
      fromIndex: number
