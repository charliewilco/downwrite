...
export function BlockQuote(props: IToolbarIcons) {
  return (
...
export function BulletedList(props: IToolbarIcons) {
  return (
...
export function Numbers(props: IToolbarIcons) {
  return (
...
export function Code(props: IToolbarIcons) {
  return (
...
export function Bold(props: IToolbarIcons) {
  return (
...
export function Italic(props: IToolbarIcons) {
  return (
...
export function Underline(props: IToolbarIcons) {
  return (
...
export function Mono(props: IToolbarIcons) {
  return (
