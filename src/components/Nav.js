...
export default class extends Component {
	...
	render() {
		return (
				<Flex component='nav' width={384} backgroundColor="white" height="calc(100vh - 4px)" float="right">
