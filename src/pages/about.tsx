      ...
      <div className="xl:pb-0 xl:col-span-3 xl:row-span-2">
        <div data-testid="ABOUT_PAGE" className="font-serif __content py-8">
          <p>
            ...
            designed iterations of this thing for every year on the year as one of
            these services got shut down. When Canvas shut down this last year, I
            started to get a little more serious about this idea.
          </p>
          <p>
            During planning out some of my quarterly goals at my last job I decided
            to go a little more full-stack with Node and start to really work through
            the process of building a microservice. Since I&#39;m never really one to
          ...
          <p>
            ...
            save a local draft of your work and let you work without a connection and
            suggest a draft to save when you&#39;re back online.
          </p>
          <h2>Why Markdown?</h2>
          <p>
          ...
          <p>
            ...
            conceived as a text to HTML and is the stable of static site generators,
            OSS and a fair amount.
          </p>
        </div>
      </div>
    </Content>
