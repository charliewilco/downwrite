...
export const BlockQuote: React.FC<IToolbarIcons> = props => (
...
export const BulletedList: React.FC<IToolbarIcons> = props => (
...
export const Numbers: React.FC<IToolbarIcons> = props => (
...
export const Code: React.FC<IToolbarIcons> = props => (
...
export const Bold: React.FC<IToolbarIcons> = props => (
...
export const Italic: React.FC<IToolbarIcons> = props => (
...
export const Underline: React.FC<IToolbarIcons> = props => (
...
export const Mono: React.FC<IToolbarIcons> = props => (
